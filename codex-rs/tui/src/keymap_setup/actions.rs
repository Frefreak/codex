...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("global", "Global", "cycle_permission_profile", "Cycle through allowed named permission profiles."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("global", "cycle_permission_profile") => Some(&mut keymap.global.cycle_permission_profile),
